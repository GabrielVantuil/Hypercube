...
#define HOTEND_OFFSET_X {0.0, 17.50} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 87.05}
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS/2), (Y_MAX_POS - 10), 5 }
